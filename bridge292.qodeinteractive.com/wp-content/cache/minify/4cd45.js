...
function initQodeSlider() {
    ...
    if (default_header_style = "", $j("header.page_header").hasClass("light") && (default_header_style = "light"), $j("header.page_header").hasClass("dark") && (default_header_style = "dark"), $j(".carousel").length) {
        ...
        ! function(e) {
            ...
            function o(e, t) {
                var o = t;
                e.hasClass("advanced_responsiveness") ? $window_width > v[0] ? o = t : $window_width > v[1] ? o = .75 * t : $window_width > v[2] ? o = .6 * t : $window_width > v[3] ? o = .55 * t : $window_width <= v[3] && (o = .45 * t) : $window_width > v[0] ? o = t : $window_width > v[1] ? o = .8 * t : $window_width > v[2] ? o = .7 * t : $window_width <= v[2] && (o = 1 * t), e.css({
                    height: o + "px"
            ...
            function a(e, t) {
                $window_width > v[0] ? (c = j[0], h = w[0], u = b[0], _ = q[0], f = y[0]) : $window_width > v[1] ? (c = j[1], h = w[1], u = b[1], _ = q[1], f = y[1]) : $window_width > v[2] ? (c = j[2], h = w[2], u = b[2], _ = q[2], f = y[2]) : $window_width > v[3] ? (c = j[3], h = w[3], u = b[3], _ = q[3], f = y[3]) : $window_width > v[4] ? (c = j[4], h = w[4], u = b[4], _ = q[4], f = y[4]) : $window_width > v[5] ? (c = j[5], h = w[5], u = b[5], _ = q[5], f = y[5]) : (c = j[6], h = w[6], u = b[6], _ = q[6], f = y[6]);
                var o = h,
                    i = u,
                    n = _;
                $window_width <= v[0] && (o = h / 2, i = u / 2, n = _ / 2), e.find(".thumb").css({
            ...
            if (p.hasClass("full_screen")) p.css({
                ...
                l = $j(window).width() < 1e3 ? $j("header.page_header").height() : 0, m = $window_width > 1e3 && !$j("header.page_header").hasClass("transparent") && 0 == $j("body.paspartu_on_top_fixed").length ? $j("header.page_header").height() : 0, g = $j(".paspartu_outer:not(.disable_top_paspartu)").length > 0 ? Math.round($window_width * paspartu_width + m) : 0, $ = $j(".paspartu_outer.paspartu_on_bottom_slider").length > 0 ? Math.round($window_width * paspartu_width) : 0, p.css({
                    height: $j(window).height() - l - g - $ + "px"
                }), p.find(".qode_slider_preloader .ajax_loader").css({
                    display: "block"
                }), p.find(".item").css({
...
function initQodeCarousel() {
    ...
    $j(".qode_carousels").length && ($j(".qode_carousels").each(function() {
        ...
        var o = 1 == e.parents(".grid_section").length ? 170 : 315,
            i = 6;
        4 === t ? (o = 1 == e.parents(".grid_section").length ? 255 : 472, i = 4) : 5 === t && (o = 1 == e.parents(".grid_section").length ? 204 : 378, i = 5), console.log(i), e.find(".slides").carouFredSel({
            circular: !0,
            responsive: !0,
            scroll: {
                items: 1,
...
function createSelectContentMenu() {
    ...
    $j(".content_menu").each(function() {
        ...
        t.appendTo($j(this).find(".nav_select_menu")), $j(this).find("ul.menu li a").each(function() {
            ...
            var t = $j(this),
                o = t.attr("href"),
                i = $j("div.wpb_row[data-q_id='" + o + "'],section.parallax_section_holder[data-q_id='" + o + "']").offset().top;
...
function contentMenuScrollTo() {
    ...
    $j("nav.content_menu").length && $j("nav.content_menu ul.menu li a").on("click", function(e) {
        ...
        var o = t.attr("href"),
            i = $j("div.wpb_row[data-q_id='" + o + "'],section.parallax_section_holder[data-q_id='" + o + "']").offset().top - content_line_height - content_menu_top - content_menu_top_add;
        return $j("html,body").stop().animate({
            scrollTop: i
        }, 500, "swing", function() {
            $j("nav.content_menu ul li").removeClass("active"), t.parent().addClass("active")
...
function initVerticalSplitSlider() {
    "use strict";
    if ($j("html").hasClass("vertical_split_screen_initalized") && ($j("html").removeClass("vertical_split_screen_initalized"), $j.fn.multiscroll.destroy(), $j("#multiscroll-nav").remove(), console.log("destroyed")), $j(".vertical_split_slider").length) {
        var e = "";
        e = $j("header.page_header").hasClass("light") ? "light" : $j("header.page_header").hasClass("dark") ? "dark" : header_style_admin;
...
function initializeGoogleMap(e, t, o, i, n, a, r, s, d, l, c, h, u, _) {
    ...
    if ("undefined" != typeof google) {
        ...
        h = new google.maps.Map(document.getElementById(d), $), h.mapTypes.set("qode_style", m);
        var v;
        for (v = 0; v < _.length; ++v) initializeGoogleAddress(_[v], c, h, u);
...
function(e) {
    ...
    function o() {
        function t(e, t, o) {
            ...
            "next" === o ? n(e, i - a + v, a - t) : n(e, i + a - v)
        }
        ...
        if (t.length) {
            var o = t.height(),
                ...
                v = function() {
                    ...
                    var u = function() {
                        s.is(":visible") && l.is(":visible") ? ($(r), a.one(qode.animationEnd, function() {
                            $(d), s.one(qode.animationEnd, function() {
                        ...
                        })) : ($(r), a.one(qode.animationEnd, function() {
                            setTimeout(function() {
                                requestAnimFrame(u)
                            }, h)
                        }))
