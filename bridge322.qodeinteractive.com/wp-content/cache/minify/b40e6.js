    ...
    if (default_header_style = "", $j("header.page_header").hasClass("light") && (default_header_style = "light"), $j("header.page_header").hasClass("dark") && (default_header_style = "dark"), $j(".carousel").length) {
        ...
        ! function(e) {
            ...
            if (p.hasClass("advanced_responsiveness")) {
                $ = [1600, 1200, 900, 650, 500, 320], p.data("q_responsive_breakpoints") && "set2" == p.data("q_responsive_breakpoints") && ($ = [1600, 1300, 1e3, 768, 567, 320]);
...
function initCountdown() {
    ...
    $j(".countdown").length && $j(".countdown").each(function() {
        var e, t, o, i, n, a, r, s, d, l, c, h, u, _, f = $j(this).attr("id"),
            ...
            $ = 0,
            j = 0;
        void 0 !== p.data("year") && !1 !== p.data("year") && (m = p.data("year")), void 0 !== p.data("month") && !1 !== p.data("month") && (g = p.data("month")), void 0 !== p.data("day") && !1 !== p.data("day") && (v = p.data("day")), void 0 !== p.data("hour") && !1 !== p.data("hour") && ($ = p.data("hour")), void 0 !== p.data("minute") && !1 !== p.data("minute") && (j = p.data("minute")), void 0 !== p.data("monthslabel") && !1 !== p.data("monthslabel") && (e = p.data("monthslabel")), void 0 !== p.data("monthlabel") && !1 !== p.data("monthlabel") && (t = p.data("monthlabel")), void 0 !== p.data("dayslabel") && !1 !== p.data("dayslabel") && (o = p.data("dayslabel")), void 0 !== p.data("daylabel") && !1 !== p.data("daylabel") && (i = p.data("daylabel")), void 0 !== p.data("hourslabel") && !1 !== p.data("hourslabel") && (n = p.data("hourslabel")), void 0 !== p.data("hourlabel") && !1 !== p.data("hourlabel") && (a = p.data("hourlabel")), void 0 !== p.data("minuteslabel") && !1 !== p.data("minuteslabel") && (r = p.data("minuteslabel")), void 0 !== p.data("minutelabel") && !1 !== p.data("minutelabel") && (s = p.data("minutelabel")), void 0 !== p.data("secondslabel") && !1 !== p.data("secondslabel") && (d = p.data("secondslabel")), void 0 !== p.data("secondlabel") && !1 !== p.data("secondlabel") && (l = p.data("secondlabel")), void 0 !== p.data("tickf") && !1 !== p.data("tickf") && p.data("tickf"), void 0 !== p.data("timezone") && !1 !== p.data("timezone") && (c = p.data("timezone")), void 0 !== p.data("digitfs") && !1 !== p.data("digitfs") && (h = p.data("digitfs")), void 0 !== p.data("labelfs") && !1 !== p.data("labelfs") && (u = p.data("labelfs")), void 0 !== p.data("color") && !1 !== p.data("color") && (_ = p.data("color")), p.countdown({
    ...
    if ($j(".blog_vertical_loop").length) {
        ...
        $j(document).on("click", ".blog_vertical_loop_button a", function(a) {
            ...
            n.find("article:eq(1)").addClass("fade_out"),
                r.closest("article").addClass("move_up").removeClass("next_post").css("transform", "translateY(-" + u + "px)"), setTimeout(function() {
