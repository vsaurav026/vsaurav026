...
(function() {
    ...
    */
        ...
        Lc, Mc, Nc, Oc = function(a, b) {
            ...
            for (f in a)
                if (a.hasOwnProperty(f))
                    if (0 === f.indexOf("vtp_")) d && b && b.Nf && b.Nf(a[f]), e[void 0 !== d ? f : f.substr(4)] = a[f];
    ...
    var Zd = [O.D, O.I],
        $d = function(a) {
            ...
            for (var d = va(b) ? b : [b], e = {
                    ...
                    Qb: e.Qb
                }, ++e.Qb) Ea(a, function(f) {
                return function(g, k) {
                    if (g !== O.Ne && g !== O.Oe) {
                        var m = d[f.Qb];
                        Dd().set(g, k, m, "IN", "IN-DL", c)
                    }
                }
            }(e))
        },
    ...
    $e.M = "GTM-WCC77WV";
    $e.cd = "9m0";
    $e.Kg = "ChEI8LTAigYQyNS/jLq8lPecARIkAFXw3cPu8tHaw5S7xDGB8TeqIgcrn+h06ZCiuQwM07tVE/zMGgILbA\x3d\x3d";
    var bf = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var ff = ef,
        ...
        hf = null,
        jf = null,
        kf = "https://www.googletagmanager.com/a?id=" + $e.M + "&cv=12",
        lf = {},
        mf = {},
        nf = function() {
            var a = R.sequence || 1;
    ...
    var Zf = function(a) {
        ...
        $f = new RegExp(/[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i),
        ag = new RegExp(/@(gmail|googlemail)\./i),
        bg = new RegExp(/support|noreply/i),
        cg = "SCRIPT STYLE IMG SVG PATH BR".split(" "),
        dg = ["BR"],
        eg = {};
            ...
            if (c) {
                ...
                if ("js_variable" === d) {
                    ...
                    for (var g = e.split(","), k = 0; k < g.length; k++) {
                        var m = g[k].trim();
                        if (m) {
                            if (0 === m.indexOf("dataLayer.")) f = uf(m.substring(10));
                            else {
                                var n = m.split(".");
                                f = B[n.shift()];
    ...
    var Mh = function() {
            var a = Uf(B.location.href),
                b = Sf(a, "query", !1, void 0, "gclid"),
                c = Sf(a, "query", !1, void 0, "gclsrc"),
                d = Sf(a, "query", !1, void 0, "wbraid"),
                e = Sf(a, "query", !1, void 0, "dclid");
            if (!b || !c || !d) {
    ...
    function Nh(a, b, c, d, e) {
        ...
        if ((void 0 == zh.enable_gbraid_cookie_write ? 0 : zh.enable_gbraid_cookie_write) && !m && a.gb) {
            var q = a.gb[0],
                ...
                u = !1;
            if (!b)
                for (var r = Fh(t), v = 0; v < r.length; v++) r[v].qa === q && r[v].labels && 0 < r[v].labels.length && (u = !0);
            u || f("gb", p(q))
        }
    }
    var Rh = function(a, b) {
                ...
                for (var d = Kh(b.prefix), e = 0; e < a.length; ++e) {
                    ...
                    if (void 0 !== Ch[f]) {
                        var g = Ph(f, d),
                            k = c[g];
                        if (k) {
                            var m = Math.min(Qh(k), l()),
                                n;
                            b: {
                                var p = m;
                                if (sg(B))
                                    for (var q = xg(g, G.cookie, void 0, "ad_storage"), t = 0; t < q.length; ++t)
                                        if (Qh(q[t]) > p) {
                                            n = !0;
                                            break b
                                        }
                ...
                Eh(function() {
                    Ea(d, function(f, g) {
                        ...
                        if (k.length) {
                            var m = k[0],
                                n = Qh(m),
                                p = 0 !== Sh(m.split(".")).length ? m.split(".").slice(3) : [],
                                q = {},
                                t;
    ...
    var Zh = function(a) {
        ...
        $h = function(a) {
            var b = Uf(B.location.href),
                c = Sf(b, "host", !1);
            if (c && c.match(bi)) {
                var d = Sf(b, "path").split(a +
                    "=");
                if (1 < d.length) return d[1].split(";")[0].split("?")[0]
            }
        },
        ci = function(a, b) {
            Rd(O.D) ? ce(O.D) ? a() : Xd(a, O.D) : b ? yd(42) : ge(function() {
                ci(a, !0)
            }, [O.D])
        },
        bi = /^\d+\.fls\.doubleclick\.net$/,
        di = function(a, b) {
            return ai("aw", a, b)
        },
        ei = function(a, b) {
            ...
            var b = $h("gac");
            return b ? !ce(O.D) && a ? "0" : decodeURIComponent(b) : Zh(Dh() ? Vg() : {})
        },
        gi = function(a) {
            var b = $h("gacgb");
            return b ? !ce(O.D) && a ? "0" : decodeURIComponent(b) : Zh(Dh() ? Vg("_gac_gb", !0) : {})
        },
        hi = function(a) {
            var b = Mh(),
                c = [],
        ...
        ii = function(a) {
            var b;
            if ($h("gclaw") || $h("gac") || 0 < (Mh().aw || []).length) b = !1;
            else {
                var c;
                if (0 < (Mh().gb || []).length) c = !0;
                else {
    ...
    var ki = function(a) {
        var b = a ? ng(a) : B.enhanced_conversion_data,
            c = (a || {}).enhanced_conversions_mode;
        if (B.Promise) try {
            return b ? Ee(b).then(function(d) {
                d.Wh = c;
                return d
            }) : Promise.resolve({
                yc: "",
    ...
    var li = function(a) {
        ...
        mi = function() {
            if (gf || !0 !== B._gtmdgs && !ji("11")) return -1;
            var a = Ia('1');
    ...
    var Ki = function() {
            ...
            if (!R._li && B.performance && B.performance.timing) {
                var b = B.performance.timing.navigationStart,
                    c = ua(vf.get("gtm.start")) ? vf.get("gtm.start") : 0;
                R._li = {
                    cst: a(c - b),
                    cbt: a(jf - b)
                }
    ...
    var Ri = function(a) {
            ...
            if (B[b]) B.hasOwnProperty(b) || yd(12);
            else {
                var c = function() {
                    c.q = c.q || [];
                    c.q.push(arguments)
    ...
    var cj = function(a) {},
        ...
        kj = function(a) {
            ...
            var c = xd("GTM"),
                d = xd("TAGGING");
            return [Aj, rj[b] ? "" : "&es=1",
                Bj[b], cj(b), c ? "&u=" + c : "", d ? "&ut=" + d : "", jj(), sj, tj, zj, yj, ij(a), xj, "&z=0"
            ].join("")
        },
        Dj = function() {
            Aj = Cj()
    ...
    function ek(a, b, c, d) {
        function e() {
            if (f[bc.Fh]) k();
                ...
                var y = Fi(c.nb, String(f[bc.mb]), Number(f[bc.Bf]), x[bc.Gh]),
                    A = !1;
    ...
    function rk(a, b) {
        if (!b) return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && Ic[c] && !cf[String(Ic[c][bc.mb])]) return !0;
        return !1
    }
    ...
    var hl = function(a, b) {
        ...
        ll = function(a) {
            function b(r) {
                ...
                v = R.reported_gclid;
                var x;
                x = !g || Sd() && !ce(O.D) ? m + (r ? "gcu" : "gcs") : m + "." + (f.prefix || "_gcl") + (r ? "gcu" : "gcs");
                if (!v[x]) {
                    v[x] = !0;
                    var z = [],
                        w = {},
                    ...
                    if (Sd()) {
                        ...
                        r && y("gcu", "1");
                        Td() && y("gcd", ee());
                        R.dedupe_gclid || (R.dedupe_gclid = "" + Jg());
                        y("rnd", R.dedupe_gclid);
                        if ((!m || n && "aw.ds" !== n) && ce(O.D)) {
                            var F = Gh("_gcl_aw");
                            y("gclaw", F.join("."))
                        }
                    ...
                    y("gclid", hl(d, m));
                    y("gclsrc", n);
                    if (!(w.gclid || w.dclid || w.gclaw) && (y("gbraid", hl(d, q)), !w.gbraid && Sd() && ce(O.D))) {
                        var D = Gh("_gcl_gb");
                        y("gclgb", D.join("."))
                    }
                    y("gtm", Ak(!e));
                    g && ce(O.D) && (Tg(f || {}), y("auid", Qg[Rg(f.prefix)] || ""));
                    jl || a.jd &&
                        y("did", a.jd), kl && (a.Nb && y("gdid", a.Nb), a.Mb && y("edid", a.Mb));
            ...
            var c = !!a.ne,
                ...
                u = Sd();
            if (t || u) u ? ge(function() {
                b();
                ce(O.D) || fe(function(r) {
                    return b(!0, r.Xh)
                }, O.D)
            }, [O.D]) : b()
        },
    ...
    var Dl = function(a, b, c) {
            ...
            B[a.functionName] = d;
            if (a.fd)
                for (var e = 0; e < a.fd.length; e++) B[a.fd[e]] = B[a.fd[e]] || Cl();
    ...
    var Wm = function(a, b) {},
        ...
        jn = function(a, b, c) {
                ...
                k(function() {
                    if (!c.isGtmEvent && $b(D)) {
                        var M = r.ia,
                            ...
                            L;
                        for (L in D)
                            if (D.hasOwnProperty(L) && /^(dimension|metric)\d+$/.test(L) && void 0 != D[L]) {
                                var Q = K.get(Vm(D[L]));
                                bn(M, L, Q)
                            }
                    }
            ...
            if (ta(k)) {
                ...
                else b === O.za ? (u(), Ml(f, c), c.getWithConfig(O.Za) && (Wh(["aw", "dc"]), Ti(n + ".")), 0 != r.sendPageView && p("send", "pageview", r.ia), an(f, n, c)) : b === O.Ja ? Wm(n,
    ...
    var hn, gn = {},
        ...
        fn = function(a, b, c, d) {
            if (void 0 !== c)
                if (un[b] && (c = La(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Vm(b)] = c;
                else if (h(a)) d[a] = c;
            else
        ...
        Zm = function(a, b, c) {
            ...
            for (var u = Ye(c), r = 0; r < u.length; ++r) {
                ...
                if (c.isGtmEvent) {
                    ...
                    else if (/^(dimension|metric|content_group)\d+$/.test(v)) fn(1, v, z, g);
            ...
            if (c.isGtmEvent) {
                ...
                var E = f[O.na] || {},
                    D = E[O.Gb];
                D || 0 != D && E[O.O] ? m.allowLinker = !0 : !1 === D && bn(m, "useAmpClientId", !1);
    ...
    Bn.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.o.length;) {
            var f = this.o[0];
            if (f.s) yn ? !f.T || Jn(this, f.T).o ? (f.s = !1, this.o.push(f)) : c.push(f) : (f.s = !1, this.o.push(f)), this.o.shift();
            else {
                switch (f.type) {
                    case "require":
    ...
    var ap = function() {
            ...
            a.push = function() {
                ...
                if (300 <
                    this.length)
                    for (yd(4); 300 < this.length;) this.shift();
    ...
    var Ms = window,
        ...
        Os = function(a) {
            ...
            for (var d = rg("AMP_TOKEN", String(Ns.cookie), !0), e = 0; e < d.length; e++)
    ...
    Z.g.f = ["google"],
        function() {
            (function(a) {
                ...
                return b ? a.vtp_component && "URL" != a.vtp_component ? Sf(Uf(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : tp(String(b)) : String(b)
            })
        }();
            ...
            (function(b) {
                ...
                if ("QUERY" === d) a: {
                    var g = b[a("vtp_multiQueryKeys").toString()],
                        ...
                        n;g ? va(k) ? n = k : n = String(k).replace(/\s+/g,
                        "").split(",") : n = [String(k)];
                    for (var p = 0; p < n.length; p++) {
                        var q = Sf(e, "QUERY", void 0, void 0, n[p]);
                        if (void 0 != q && (!m || "" !== q)) {
                            f = q;
                            break a
                        }
                ...
                else f = Sf(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0, void 0);
                return f
            })
        }();
    Z.g.v = ["google"],
    ...
    Z.g.ua = ["google"],
        function() {
                ...
                if (Sd() && !z && !f[r]) {
                    var w = !ce(O.I),
                        y = function() {
                            ...
                            A("create", r, E);
                            w && ce(O.I) && (w = !1, A(function() {
                                var K = Pi().getByName(C);
                                !K || K.get("clientId") === D && M || (F["&gcs"] = de(), F["&gcu"] = "1", K.set(F), K.send("pageview"))
                            }));
                            A(function() {
                                A.remove(C)
                            })
            ...
            var n = function(r, v) {
                if (r)
                    for (var x in r)
                        if (!m[x] && r.hasOwnProperty(x)) {
                            var z = k[x] ? La(r[x]) : r[x];
            ...
            var p = function(r, v, x) {
                ...
                q = function(r) {
                    var v = {};
                    r.vtp_gaSettings && N(dq(r.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), v);
                    N(dq(r.vtp_fieldsToSet, "fieldName", "value"), v);
                    La(v.urlPassthrough) && (v._useUp = !0);
                    r.vtp_transportUrl && (v._x_19 = r.vtp_transportUrl);
                    if (!c) {
                        v._x_19 && (v._cd2l = !0);
                        ce(O.I) || (v.storage = "none");
                        ce(O.D) || (v.allowAdFeatures = !1, v.storeGac = !1);
                        Sm() || (v.allowAdFeatures = !1);
                        Rm() || (v.allowAdPersonalizationSignals = !1);
                        if (La(v.urlPassthrough)) {
                            var x = !1;
                            Sd() && !x && (v._cs = a)
                        }
                    }
                ...
                t = function(r, v) {
                    var x = r.vtp_autoLinkDomains || "";
                    x && Si(v, x, !!r.vtp_useHashAutoLink, !!r.vtp_decorateFormsAutoLink);
                },
                u = function(r) {
                    function v(la, da) {
                        void 0 !== r[da] && Q("set", la, r[da])
                    }

                    function x() {
                        if (r.vtp_doubleClick || "DISPLAY_FEATURES" == r.vtp_advertisingFeaturesType) {
                            var la = "_dc_gtm_" + String(r.vtp_trackingId).replace(/[^A-Za-z0-9-]/g, "");
                    ...
                    if (r.vtp_gaSettings) {
                        ...
                        N(dq(C.vtp_contentGroup, "index", "group"), w);
                        N(dq(C.vtp_dimension, "index", "dimension"), y);
                        N(dq(C.vtp_metric, "index", "metric"), A);
                        var F = N(C);
                        F.vtp_fieldsToSet =
                            void 0;
                    ...
                    N(dq(r.vtp_contentGroup, "index", "group"), w);
                    N(dq(r.vtp_dimension, "index", "dimension"), y);
                    N(dq(r.vtp_metric, "index", "metric"), A);
                    var E = q(r),
                        D = "",
                        M = Ri(r.vtp_functionName);
                    if (ta(M)) {
                        var K = "",
                            L = "";
                        r.vtp_setTrackerName && "string" == typeof r.vtp_trackerName ? "" !== r.vtp_trackerName && (L = r.vtp_trackerName, K = L + ".") : (L = "gtm" + nf(), K = L + ".");
                        var Q = function(la) {
                            ...
                            I =
                            function(la, da) {
                                return void 0 === da ? da : la(da)
                            },
                            J = function(la, da) {
                                if (da)
                                    for (var Ja in da) da.hasOwnProperty(Ja) && (c ? E[la + Ja] = da[Ja] : Q("set", la + Ja, da[Ja]))
                            },
                            T = function() {
                                return null
                            },
                            U = function(la, da) {
                                return void 0 === r[la] ? z[da] : r[la]
                            },
                            ea = String(r.vtp_trackingId || z.trackingId || "");
                        if (c) {
                            var P = function() {
                                if (r.vtp_doubleClick || "DISPLAY_FEATURES" == r.vtp_advertisingFeaturesType) E.displayfeatures = !0
                            };
                            J("contentGroup", w);
                            J("dimension", y);
                            J("metric", A);
                            var W = {};
                            r.vtp_enableEcommerce && (E.gtmEcommerceData = T());
                            if ("TRACK_EVENT" === r.vtp_trackType) D = "track_event", P(), E.eventCategory = String(U("vtp_eventCategory", "category")), E.eventAction = String(U("vtp_eventAction", "action")), E.eventLabel = I(String, U("vtp_eventLabel", "label")), E.value = I(Ia, U("vtp_eventValue", "value"));
                            else if ("TRACK_PAGEVIEW" == r.vtp_trackType) {
                                if (D = O.Vb, P(), "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == r.vtp_advertisingFeaturesType && (E.remarketingLists = !0), r.vtp_autoLinkDomains) {
                                    var ba = {};
                                    ba[O.O] =
                                        r.vtp_autoLinkDomains;
                                    ba.use_anchor = r.vtp_useHashAutoLink;
                                    ba[O.Hb] = r.vtp_decorateFormsAutoLink;
                                    E[O.na] = ba
                                }
                            } else "TRACK_SOCIAL" === r.vtp_trackType ? (D = "track_social", E.socialNetwork = String(r.vtp_socialNetwork), E.socialAction = String(r.vtp_socialAction), E.socialTarget = String(r.vtp_socialActionTarget)) : "TRACK_TIMING" == r.vtp_trackType && (D = "timing_complete", E.eventCategory = String(U("vtp_timingCategory", "category")), E.timingVar = String(U("vtp_timingVar", "name")), E.value = Ia(U("vtp_timingValue", "value")), E.eventLabel =
                                I(String, U("vtp_timingLabel", "label")));
                            r.vtp_enableRecaptcha && (E.enableRecaptcha = !0);
                            r.vtp_enableLinkId && (E.enableLinkId = !0);
                            n(E, W);
                            E.name || (W.gtmTrackerName = L);
                            W.gaFunctionName = r.vtp_functionName;
                            void 0 !== r.vtp_nonInteraction && (W.nonInteraction = r.vtp_nonInteraction);
                            var ma = Xe(Ue(Pe(W), r.vtp_gtmOnSuccess), r.vtp_gtmOnFailure);
                            ma.isGtmEvent = !0;
                            kn(ea, D, Date.now(), ma)
                        }
                        if (!c) {
                            var Ba = function(la, da) {
                                    void 0 !== da && Q("set", la, da)
                                },
                                Ha = {
                                    name: L
                                };
                            ...
                            J("metric", A);
                            var ed = !1;
                            Sd() && !ed && (Q("set", "&gcs", de()), b(ea, r, L));
                            E._x_19 && E._x_20 && !e[L] && (e[L] = !0, M(Wi(L, String(E._x_20))));
                            r.vtp_enableRecaptcha && Q("require", "recaptcha", "recaptcha.js");
                            v("nonInteraction", "vtp_nonInteraction");
                            var Fe = {};
                            p(E, Fe, !1) && Q("set", Fe);
                            r.vtp_enableLinkId && Q("require", "linkid", "linkid.js");
                            Q("set", "hitCallback", function() {
                                var la = E && E.hitCallback;
                                ta(la) && la();
                                r.vtp_gtmOnSuccess()
                            })
                        }
                        ...
                        if ("TRACK_EVENT" == r.vtp_trackType) {
                            if (!c) {
                                r.vtp_enableEcommerce && (Q("require", "ec", "ec.js"), T());
                                x();
                                var Ge = {
                                    hitType: "event",
                                    ...
                                    eventValue: I(Ia, U("vtp_eventValue", "value"))
                                };
                                p(Vb, Ge, !1);
                                Q("send", Ge);
                            }
                            ...
                            if ("DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == r.vtp_advertisingFeaturesType) {
                                var Gd = "_dc_gtm_" + String(r.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
                                    "");
                                Q("require", "adfeatures", {
                                    cookieName: Gd
                                })
                            }
                            Vb ? Q("send", "pageview", Vb) : Q("send", "pageview");
                            t(r, K);
                            La(E.urlPassthrough) && Ti(K)
                        }
                        if (!d) {
                            var Dc = r.vtp_useDebugVersion ? "u/analytics_debug.js" : "analytics.js";
                            r.vtp_useInternalVersion && !r.vtp_useDebugVersion && (Dc = "internal/" + Dc);
                            d = !0;
                            var Ie = uk(E._x_19, "/analytics.js"),
                                hd = Bl("https:", "http:", "//www.google-analytics.com/" + Dc, E && !!E.forceSSL);
                            V("analytics.js" === Dc && Ie ? Ie : hd, function() {
                                var la = Pi();
                                la && la.loaded || r.vtp_gtmOnFailure();
                            }, r.vtp_gtmOnFailure)
                        }
                    } else H(r.vtp_gtmOnFailure)
                };
            (function(r) {
                Z.__ua = r;
                Z.__ua.h = "ua";
    ...
    Z.g.gclidw = ["google"],
        function() {
            ...
            (function(b) {
                ...
                b.vtp_enableCrossDomainFeature && (b.vtp_enableCrossDomain && !1 === b.vtp_acceptIncoming || (b.vtp_enableCrossDomain || xh()) &&
                    Rh(a, g));
                Oh(g);
                Uh(["aw", "dc"], g);
                hi(g);
                ...
                if (b.vtp_enableCrossDomainFeature && b.vtp_enableCrossDomain && b.vtp_linkerDomains) {
                    ...
                    Th(a, m, b.vtp_urlPosition, !!b.vtp_formDecoration, k)
                }
                var n = up(O.U);
                ll({
                    ne: !1,
                ...
                b.vtp_enableUrlPassthrough && Wh(["aw", "dc", "gb"])
            })
        }();
    ...
    Z.g.aev = ["google"],
        function() {
            ...
            function d(u, r) {
                if (!u) return !1;
                var v = e(rp());
                va(r) || (r = String(r || "").replace(/\s+/g, "").split(","));
            ...
            function k(u) {
                if ("form" === u.tagName.toLowerCase() && u.elements) {
                    for (var r = 0, v = 0; v < u.elements.length; v++) Un(u.elements[v]) &&
                        r++;
                    return r
                }
            }
                        ...
                        a: {
                            ...
                            switch (F) {
                                ...
                                case "IS_OUTBOUND":
                                    ...
                                    break a;
                                default:
                                    y = Sf(C, F, u.vtp_stripWww, u.vtp_defaultPages, u.vtp_queryKey)
                            }
                        }
                        return y;
                    case "ATTRIBUTE":
                        var E;
                        if (void 0 === u.vtp_attribute) E = c(z, r, x, v);
                        else {
    ...
    Z.g.awct = ["google"],
        function() {
            ...
            var b = !1,
                c = [],
                d = function(k) {
                    var m = X("google_trackConversion"),
                        n = k.gtm_onFailure;
            ...
            (function(k) {
                ...
                function m(P) {
                    D.google_gtm_experiments = D.google_gtm_experiments || {};
                    D.google_gtm_experiments[P] = !0
                }

                function n(P, W, ba) {
                    return "DATA_LAYER" === P ? up(ba) : k[W]
                }

                function p() {
                    I("gdpr_consent", dl()), I("gdpr", fl());
                }

                function q() {
                    if (Zf(k.vtp_conversionId)) {
                        var P = l(),
                            W = ig();
                        if (0 !== W.elements.length) {
                            for (var ba = [], ma = [], Ba = 0; Ba < W.elements.length; ++Ba) {
                                var Ha = W.elements[Ba];
                                ba.push(Ha.querySelector);
                                ma.push(jg(Ha))
                            }
                            var ed = l();
                            I("ec_sel", ba.join(","));
                            I("ec_meta", ma.join(","));
                            I("ec_lat", String(ed - P));
                            I("ec_s", W.status)
                        }
                    }
                }
                ...
                function t() {
                    if (k.vtp_enableEnhancedConversion) {
                        var P;
                        void 0 === k.vtp_dataSource ? P = k.vtp_cssProvidedEnhancedConversionValue ||
                            k.vtp_enhancedConversionObject : "DATA_OBJECT" === k.vtp_dataSource ? P = k.vtp_enhancedConversionObject : "INDIVIDUAL_FIELDS" === k.vtp_dataSource && (P = k.vtp_cssProvidedEnhancedConversionValue);
                        if (P) return {
                ...
                function u(P) {
                    ...
                    if (P) {
                        ...
                        if (r) {
                            ...
                            Tg(ba);
                            I("auid", Qg[Rg(ba.prefix)])
                        }
                    }
                    if ((k.vtp_enableEnhancedConversions || k.vtp_enableEnhancedConversion) && P) {
                        var Ba = ki(t());
                        Ba && W.push(Ba.then(function(Ha) {
                            I("em", Ha.yc)
                        }))
                    }
                    if (W.length) try {
                ...
                var r = !k.hasOwnProperty("vtp_enableConversionLinker") || !!k.vtp_enableConversionLinker,
                ...
                if (a) {} else {
                    ...
                    k.vtp_rdp && (D.google_restricted_data_processing = !0);
                    void 0 != up(O.U) && !1 !== up(O.U) && (D.google_gtm_url_processor = function(P) {
                        return P = li(P)
                    });
                    var K = function(P) {
                            return function(W, ba, ma) {
                                var Ba = n(P, ba, ma);
                                Ba && (D[W] = Ba)
                            }
                        },
                        L = K("JSON");
                    L("google_conversion_currency",
                        "vtp_currencyCode");
                    L("google_conversion_order_id", "vtp_orderId");
                    k.vtp_enableProductReporting && (L = K(k.vtp_productReportingDataSource), L("google_conversion_merchant_id", "vtp_awMerchantId", "aw_merchant_id"), L("google_basket_feed_country", "vtp_awFeedCountry", "aw_feed_country"), L("google_basket_feed_language", "vtp_awFeedLanguage", "aw_feed_language"), L("google_basket_discount", "vtp_discount", "discount"), L("google_conversion_items", "vtp_items", "items"), D.google_conversion_items && D.google_conversion_items.map &&
                        (D.google_conversion_items = D.google_conversion_items.map(function(P) {
                            return {
                                value: P.price,
                                quantity: P.quantity,
                                item_id: P.id
                    ...
                    var Q = function(P, W) {
                            (D.google_additional_params = D.google_additional_params || {})[P] = W
                        },
                        I = function(P, W) {
                            void 0 !== W && ((D.google_additional_conversion_params = D.google_additional_conversion_params || {})[P] = W)
                        },
                        J = function(P) {
                            return function(W, ba, ma, Ba) {
                                var Ha = n(P, ba, ma);
                                Ba(Ha) && I(W, Ha)
                            }
                        };
                    var T = up("developer_id"),
                        U = Xa($b(T) ?
                            T : {});
                    U && I("did", U);
                    (function() {
                        if (!k.vtp_enableShippingData) return;
                        I("delopc", k.vtp_deliveryPostalCode);
                        I("oedeld", k.vtp_estimatedDeliveryDate);
                        I("delc", k.vtp_deliveryCountry);
                        I("shf", k.vtp_shippingFee);
                        if (k.vtp_enableProductReporting) {
                            var P = n(k.vtp_productReportingDataSource, "vtp_items", "items");
                            I("iedeld", oi(P))
                        }
                    })();
                    k.vtp_transportUrl && (D.google_transport_url =
                        k.vtp_transportUrl);
                    var ea = uk(k.vtp_transportUrl, "/pagead/conversion_async.js");
                    ea || (ea = ni() ? "https://www.google.com/pagead/conversion_async.js" : "//www.googleadservices.com/pagead/conversion_async.js");
                    k.vtp_enableNewCustomerReporting && (L = J(k.vtp_newCustomerReportingDataSource), L("vdnc", "vtp_awNewCustomer", "new_customer", function(P) {
                        return void 0 != P && "" !== P
                    }), L("vdltv", "vtp_awCustomerLTV", "customer_lifetime_value", function(P) {
                        return void 0 != P && "" !== P
                    }));
                    r ? (k.vtp_conversionCookiePrefix && (D.google_gcl_cookie_prefix =
                        k.vtp_conversionCookiePrefix), D.google_read_gcl_cookie_opt_out = !1) : D.google_read_gcl_cookie_opt_out = !0;
                    "1" === qh(!1)._up && I("gtm_up", "1");
                    p();
                    (function() {})();
                    (function() {
                        var P = !1;
                        !Sd() || P ? u(!0) : ge(function() {
                            p();
                            var W = ce(O.D),
                                ba = void 0 != up(O.U) && !1 !== up(O.U),
                                ma = !1;
                            ma = !0;
                            k.vtp_transportUrl || W || !ba && !ma || (D.google_transport_url = "https://pagead2.googlesyndication.com/");
                            I("gcs", de());
                            Td() && I("gcd", ee());
                            u(W);
                            W || fe(function() {
                                D = N(D);
                                p();
                                !k.vtp_transportUrl && D.google_transport_url && delete D.google_transport_url;
                                I("gcs", de());
                                Td() && I("gcd", ee());
                                I("gcu", "1");
                                u(!0)
        ...
        function() {
            function a() {
                var c = X("document"),
                    ...
                    e = function(f) {
                        var g = f.target;
                        if (g && 3 !== f.which && !(f.yi || f.timeStamp && f.timeStamp === d)) {
                            d = f.timeStamp;
                            g = Ob(g, ["a", "area"], 100);
                            if (!g) return f.returnValue;
                            var k = f.defaultPrevented || !1 === f.returnValue,
                                m = Rn("lcl", k ? "nv.mwt" : "mwt", 0),
                                n;
                            n = k ? Rn("lcl", "nv.ids", []) : Rn("lcl", "ids", []);
                            if (n.length) {
                                var p = Nn(g, "gtm.linkClick", n);
                                if (b(f, g, c) && !k && m && g.href) {
                                    var q = !!xa(String(Qb(g, "rel") || "").split(" "), function(r) {
                                        return "noreferrer" === r.toLowerCase()
                                    });
                                    q && yd(36);
                                    var t = X((Qb(g, "target") || "_self").substring(1)),
                                        u = !0;
                                    if (vp(p, Vo(function() {
                                            var r;
                                            if (r = u && t) {
    ...
    function et() {
        ...
        if (b) {
            ...
            xi = !1;
            yi = 0;
            if ("interactive" == G.readyState && !G.createEventObject || "complete" == G.readyState) Ai();
            else {
